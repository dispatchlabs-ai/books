...
Books is a local-first general ledger and headless financial backend for humans, software agents, and client applications. It keeps exact double-entry books in SQLite, makes posted accounting immutable, and provides a short noninteractive workflow for manual bookkeeping alongside the lower-level multi-entity and evidence-import interfaces.
